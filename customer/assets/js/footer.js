async function showFooter(){
	...
	footerHTML += '<p>Privacy Policy</p>   '
	footerHTML += '<p>Terms & Conditions</p>   '
	footerHTML += '<p>Ethics</p>   '
	footerHTML += '<p>Code of conduct</p>  '
	footerHTML += '</div>'
	footerHTML += '</div>'
	footerHTML += '</div>'
	footerHTML += '<br><br>'
	...
	footerHTML += '<ul>'
	footerHTML += '<li><a href="#"><i class="ion-social-facebook"></i></a></li>'
	footerHTML += '<li><a href="#"><i class="ion-social-twitter"></i></a></li>'
	footerHTML += '<li><a href="#"><i class="ion-social-googleplus"></i></a></li>'
	footerHTML += '<li><a href="#"><i class="ion-social-youtube"></i></a></li>'
	footerHTML += '</ul>'
	footerHTML += '</div> '
	footerHTML += '</div>'
	footerHTML += '</div>'
