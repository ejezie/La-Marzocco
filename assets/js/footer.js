async function showFooter(){
	...
	footerHTML += '<p><a href="mailto:info.australia@lamarzocco.com">info.australia@lamarzocco.com</a></p>'
	footerHTML += '</div>'
	footerHTML += '</div>'
	footerHTML += '<div class="col-lg-4 col-md-6">'
	footerHTML += '<div class="widgets_container">'
	...
	footerHTML += '<div class="col-lg-4 col-md-6">'
	footerHTML += '<div class="widgets_container">'
	footerHTML += '<h3 style="text-transform: lowercase;">Orders </h3>'
	footerHTML += '<p><a href="mailto:orders.au@lamarzocco.com">orders.au@lamarzocco.com</a></p>'
	footerHTML += '<p>T +61 2 8396 6111</p>'
	footerHTML += '</div>'
	footerHTML += '</div>'
	footerHTML += '<div class="col-lg-4 col-md-6">'
