function sideNavBar(){
	...
	if (role == 5){
		...
		sideNavBarHTML +=  '</li>'
		sideNavBarHTML +=  '<li><a><i class="fa fa-info-circle"></i> ENQUIRY <span class="fa fa-chevron-down"></span></a>'
		sideNavBarHTML +=  '<ul class="nav child_menu">'
		sideNavBarHTML +=  '<li><a href="trainingEnquiry.html">Training Enquiry</a></li>'
		sideNavBarHTML +=  '<li><a href="aftersalesEnquiry.html">Aftersales Enquiry</a></li>'
		sideNavBarHTML +=  '</ul>'
		sideNavBarHTML +=  '</li>'
