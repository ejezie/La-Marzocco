function sideNavBar(){
	...
	if (role == "Super Admin"){
		...
		sideNavBarHTML +=  '<a href="dashboard.html" class="site_title"> <img src="/home/umesh/Akash/Project_lamarzocco/LMA_Frontend_Code/Frontend/adminDashboard/images/logo.png" width="200" height="60"></a>'
		sideNavBarHTML +=  '</div>'
		...
		sideNavBarHTML +=  '<h3>General</h3>'
		sideNavBarHTML +=  '<ul class="nav side-menu">'
		sideNavBarHTML +=  '<li><a href="dashboard.html"><i class="fa fa-home"></i> Home </a>'
		sideNavBarHTML +=  '</li>'
		...
		sideNavBarHTML +=  '<h3>General</h3>'
		sideNavBarHTML +=  '<ul class="nav side-menu">'
		sideNavBarHTML +=  '<li><a><i class="fa fa-home"></i> Home </a>'
		sideNavBarHTML +=  '</li>'
		sideNavBarHTML +=  '<li><a><i class="fa fa-bar-chart-o"></i> Reports <span class="fa fa-chevron-down"></span></a>'
		sideNavBarHTML +=  '<ul class="nav child_menu">'
		sideNavBarHTML +=  '<li><a href="customerOrdersReport.html">Customer Orders Report</a></li>'
